...
// Example-local project config for RoverCorrectionBridge.
...
// RoverCorrectionBridge defaults to rover profile flow.
...
#define LC29H_CFG_BRIDGE_FORWARD_NMEA_GST 1
#define LC29H_CFG_BRIDGE_FORWARD_NMEA_RMC 1
